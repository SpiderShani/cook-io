...
const $gridsList=document.querySelector("[data-grid-list]")
...
let nextPageUrl =""
$gridsList.innerHTML= $skeletonCard.repeat(20)
...
$gridsList.innerHTML = ""
requestBefore = false
if(data.hits.length){renderRecipe(data)
}
else{
